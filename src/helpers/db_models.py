...
class Infos(DbBase):
    ...
    def __repr__(self) -> str:
        return f"fullname = {self.fullname}, email = {self.email}, phone = {self.phone}, biography = {self.biography}"
...
if __name__ == "__main__":
    ...
    # acc3 = Accounts(username="testing789", password="pass789", info=Info(
    #     fullname="Jonny",
    ...
    # acc4 = Accounts(username="testing101112", password="pass101112", info=Info(
    #     fullname="Bing Chat",
